...
boost::shared_ptr<KeyFrame> MainWindow::createKeyframe(JointSet &js)
{    
...
void MainWindow::addKeyFrameButtClicked()
{
    ...
    boost::shared_ptr<KeyFrame> keyframe = createKeyframe(js);
...
void MainWindow::UpdateKeyFrameSequenceEntry(joints jointIndex, double jointVal)
{
    ...
    boost::shared_ptr<KeyFrame> modifiedKeyframe = createKeyframe(*iter);
